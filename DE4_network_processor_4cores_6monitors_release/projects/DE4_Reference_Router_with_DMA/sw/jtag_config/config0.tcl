...
# =============================
set MAC_0_BASE_ADDRESS     		0x20000000;			# if you ever change the SOPC address just change the MAC base address here. This will reflect in MAC/PCS/PHY config files.
...
set MAC_0 				0x32464e00; #00:4e:46:32:43:00
set MAC_1 				0x00000043;
set FRM_LENGTH  		1500;
set PAUSE_QUANT  		0;
...
source tse_mac_config0.tcl
source tse_marvel_phy0.tcl
source tse_pcs_config0.tcl
