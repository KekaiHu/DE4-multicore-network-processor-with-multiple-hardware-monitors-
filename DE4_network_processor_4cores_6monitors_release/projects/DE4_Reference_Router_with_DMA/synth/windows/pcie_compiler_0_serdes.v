...
// ============================================================
// File Name: pcie_compiler_0_serdes.v
// Megafunction Name(s):
// 			alt4gxb
//
...
`endif
	...
	wire  [5:0]   wire_cent_unit0_txdividerpowerdown;
	...
	wire  [3:0]  cmu_txdividerpowerdown;
	...
	wire  [0:0]  rx_signaldetectout_wire;
	...
	defparam
		...
		central_clk_div0.enable_refclk_out = "false",
	...
	.dprioout(),
	.powerdn(cmu_txdividerpowerdown[0]),
	.quadreset(cent_unit_quadresetout[0]),
	.rateswitch(1'b1),
	.rateswitchbaseclock(),
	...
	assign
		...
		cmu_txdividerpowerdown = {wire_cent_unit0_txdividerpowerdown[3:0]},
		...
		rx_signaldetect = {rx_signaldetectout_wire[0]},
		rx_signaldetect_wire = {wire_receive_pma0_signaldetect},
		rx_signaldetectout_wire = {wire_receive_pcs0_signaldetect},
...
endmodule //pcie_compiler_0_serdes_alt4gxb_t27b
//VALID FILE
...
`endif
	...
	wire [0:0] rx_signaldetect = sub_wire1[0:0];
	wire [16:0] reconfig_fromgxb = sub_wire2[16:0];
	wire [2:0] pipestatus = sub_wire3[2:0];
	wire [0:0] rx_pll_locked = sub_wire4[0:0];
	wire [0:0] rx_syncstatus = sub_wire5[0:0];
	wire [7:0] rx_dataout = sub_wire6[7:0];
	wire [0:0] hip_tx_clkout = sub_wire7[0:0];
	wire [0:0] pipeelecidle = sub_wire8[0:0];
	wire [0:0] rateswitchbaseclock = sub_wire9[0:0];
	wire [0:0] tx_clkout = sub_wire10[0:0];
	wire [0:0] tx_dataout = sub_wire11[0:0];
	wire [0:0] rx_ctrldetect = sub_wire12[0:0];
	wire [0:0] pipedatavalid = sub_wire13[0:0];
	wire [0:0] pipephydonestatus = sub_wire14[0:0];
	wire [0:0] pll_locked = sub_wire15[0:0];
	wire [0:0] rx_freqlocked = sub_wire16[0:0];

	pcie_compiler_0_serdes_alt4gxb_t27b	pcie_compiler_0_serdes_alt4gxb_t27b_component (
				...
				.hip_tx_clkout (sub_wire7),
				.pipeelecidle (sub_wire8),
				.rateswitchbaseclock (sub_wire9),
	 ...
	 clearbox_defparam = "effective_data_rate=2500 Mbps;enable_lc_tx_pll=false;equalizer_ctrl_a_setting=0;equalizer_ctrl_b_setting=0;equalizer_ctrl_c_setting=0;equalizer_ctrl_d_setting=0;equalizer_ctrl_v_setting=0;equalizer_dcgain_setting=1;gen_reconfig_pll=false;gxb_analog_power=AUTO;gx_channel_type=AUTO;input_clock_frequency=100.0 MHz;intended_device_family=Stratix IV;intended_device_speed_grade=2;intended_device_variant=GX;loopback_mode=none;lpm_type=alt4gxb;number_of_channels=1;operation_mode=duplex;pll_control_width=1;pll_pfd_fb_mode=internal;preemphasis_ctrl_1stposttap_setting=0;preemphasis_ctrl_2ndposttap_inv_setting=false;preemphasis_ctrl_2ndposttap_setting=0;preemphasis_ctrl_pretap_inv_setting=false;preemphasis_ctrl_pretap_setting=0;protocol=pcie;receiver_termination=oct_100_ohms;reconfig_dprio_mode=1;rx_8b_10b_mode=normal;rx_align_pattern=0101111100;rx_align_pattern_length=10;rx_allow_align_polarity_inversion=false;rx_allow_pipe_polarity_inversion=true;rx_bitslip_enable=false;rx_byte_ordering_mode=NONE;rx_channel_bonding=indv;rx_channel_width=8;rx_common_mode=0.82v;rx_cru_bandwidth_type=Medium;rx_cru_inclock0_period=10000;rx_datapath_protocol=pipe;rx_data_rate=2500;rx_data_rate_remainder=0;rx_digitalreset_port_width=1;rx_enable_bit_reversal=false;rx_enable_lock_to_data_sig=false;rx_enable_lock_to_refclk_sig=false;rx_enable_self_test_mode=false;rx_force_signal_detect=true;rx_ppmselect=32;rx_rate_match_fifo_mode=normal;rx_rate_match_pattern1=11010000111010000011;
	                      rx_rate_match_pattern2=00101111000101111100;rx_rate_match_pattern_size=20;rx_run_length=40;rx_run_length_enable=true;rx_signal_detect_threshold=4;rx_use_align_state_machine=true;rx_use_clkout=false;rx_use_coreclk=false;rx_use_cruclk=true;rx_use_deserializer_double_data_mode=false;rx_use_deskew_fifo=false;rx_use_double_data_mode=false;rx_use_pipe8b10binvpolarity=true;rx_use_rate_match_pattern1_only=false;transmitter_termination=oct_100_ohms;tx_8b_10b_mode=normal;tx_allow_polarity_inversion=false;tx_analog_power=AUTO;tx_channel_bonding=indv;tx_channel_width=8;tx_clkout_width=1;tx_common_mode=0.65v;tx_data_rate=2500;tx_data_rate_remainder=0;tx_digitalreset_port_width=1;tx_enable_bit_reversal=false;tx_enable_self_test_mode=false;tx_pll_bandwidth_type=High;tx_pll_inclk0_period=10000;tx_pll_type=CMU;tx_slew_rate=off;tx_transmit_protocol=pipe;tx_use_coreclk=false;tx_use_double_data_mode=false;tx_use_serializer_double_data_mode=false;use_calibration_block=true;vod_ctrl_setting=4;elec_idle_infer_enable=false;enable_0ppm=false;gxb_powerdown_width=1;hip_enable=true;number_of_quads=1;rateswitch_control_width=1;reconfig_calibration=true;reconfig_fromgxb_port_width=17;reconfig_togxb_port_width=4;rx_cdrctrl_enable=true;rx_cru_m_divider=0;rx_cru_n_divider=1;rx_cru_vco_post_scale_divider=2;rx_dwidth_factor=1;rx_signal_detect_loss_threshold=3;rx_signal_detect_valid_threshold=14;rx_use_external_termination=false;rx_word_aligner_num_byte=1;tx_dwidth_factor=1;tx_pll_clock_post_divider=1;tx_pll_m_divider=0;tx_pll_n_divider=1;
	                      tx_pll_vco_post_scale_divider=2;tx_use_external_termination=false;" */;
	defparam
		pcie_compiler_0_serdes_alt4gxb_t27b_component.starting_channel_number = starting_channel_number;
...
// Retrieval info: USED_PORT: rx_signaldetect 0 0 1 0 OUTPUT NODEFVAL "rx_signaldetect[0..0]"
...
// Retrieval info: CONNECT: rx_signaldetect 0 0 1 0 @rx_signaldetect 0 0 1 0
// Retrieval info: CONNECT: rx_syncstatus 0 0 1 0 @rx_syncstatus 0 0 1 0
// Retrieval info: CONNECT: tx_clkout 0 0 1 0 @tx_clkout 0 0 1 0
// Retrieval info: CONNECT: tx_dataout 0 0 1 0 @tx_dataout 0 0 1 0
// Retrieval info: GEN_FILE: TYPE_NORMAL pcie_compiler_0_serdes.v TRUE
...
// Retrieval info: GEN_FILE: TYPE_NORMAL pcie_compiler_0_serdes.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL pcie_compiler_0_serdes.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL pcie_compiler_0_serdes_inst.v FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL pcie_compiler_0_serdes_bb.v TRUE
